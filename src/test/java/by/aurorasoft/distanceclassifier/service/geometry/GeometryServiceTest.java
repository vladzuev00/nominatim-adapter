...
public final class GeometryServiceTest extends AbstractSpringBootTest {
    ...
    public void geometriesShouldContainPoint() {
        final Set<PreparedGeometry> givenGeometries = Set.of(
    ...
    @Test
    public void geometryShouldContainPoint() {
        final PreparedGeometry givenGeometry = createPreparedPolygon(
                new CoordinateXY(3, 3),
                new CoordinateXY(3, 4),
                new CoordinateXY(4, 4),
                new CoordinateXY(4, 3),
        ...
        final boolean actual = service.isContain(givenGeometry, givenPoint);
        assertTrue(actual);
    }

    @Test
    public void geometryShouldNotContainPoint() {
        final PreparedGeometry givenGeometry = createPreparedPolygon(
                new CoordinateXY(3, 3),
                new CoordinateXY(3, 4),
                new CoordinateXY(4, 4),
        ...
        final TrackPoint givenPoint = createTrackPoint(1, 2);
